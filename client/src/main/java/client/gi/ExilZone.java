...
public class ExilZone extends Pile {
	...
	public ExilZone(Environnement env) {
		super(env, "ExilZone", WIDTH_PERCENT, HEIGHT_PERCENT, CORNER_PERCENT, CARD_WIDTH_PERCENT, CARD_HEIGHT_PERCENT);
		LOGGER = LoggerFactory.getLogger("ExilZone");
	}
